      			...
      			<div class="col-md-12">
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<h3>Editar Modelo: <span class="label label-warning">{{$modelo->nombre}}</span></h3>
							@if(count($errors) > 0)
							...
							{!!Form::model($modelo, ['method' => 'PATCH', 'route' => ['modelo.update', $modelo->id]])!!}
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">	
									<div class="form-group">
										...
										<input type="text" name="nombre" class="form-control" value="{{$modelo->nombre}}" placeholder="">
									</div>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">	
									<div class="form-group">
										<label for="marca">Marca <span class="campo-o">*</span></label>
										<select class="form-control selectpicker" name="marca" disabled>
											<option value="{{$modelo->marca->id}}">{{$modelo->marca->nombre}}</option>
										</select>
									</div>
								</div>
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<div class="form-group">
										...
										<a href="{{url('modelo')}}}"><button class="btn btn-labeled btn-danger" type="button"><span class="btn-label"><i class="fa fa-undo"></i></span>Atrás</button></a>
									</div>
								</div>
							{!!Form::close()!!}
						</div>
