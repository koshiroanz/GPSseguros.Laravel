							...
							{!!Form::open(array('url' => 'modelo', 'method' => 'POST', 'autocomplete' => 'off'))!!}
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<div class="form-group">
										...
										<input type="text" name="nombre" class="form-control" placeholder="Aquí nombre modelo..." autofocus>
									</div>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<div class="form-group">
										<label for="marca">Marca <span class="campo-o">*</span></label>
										<select class="form-control selectpicker" name="marca" data-live-search="true">
