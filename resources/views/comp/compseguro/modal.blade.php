<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-delete-{{$compania->id}}">
	{{Form::open(array('action' => array('CompaniaSeguroController@destroy', $compania->id), 'method' => 'delete'))}}
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header" id="table_header">
					...
					<h4>Eliminar Compañia de Seguro</h4>
				</div>
				<div class="modal-body">
					<p class="texto-modal">¿ Está seguro de eliminar a <strong>{{$compania->nombre}}</strong> ?</p>
				</div>
