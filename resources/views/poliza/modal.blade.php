<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-delete-{{$poliza->id}}">
	{{Form::open(array('action' => array('PolizaController@destroy', $poliza->id), 'method' => 'delete'))}}
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header" id="table_header">
					...
					<h4>Eliminar Póliza</h4>
				</div>
				<div class="modal-body">
					<p class="texto-modal">¿ Está seguro de eliminar la póliza <strong>{{$poliza->numPoliza}}</strong>?</p>
				</div>
