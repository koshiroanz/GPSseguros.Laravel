<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-delete-{{$localidad->id}}">
	{{Form::open(array('action' => array('LocalidadController@destroy', $localidad->id), 'method' => 'delete'))}}
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header" id="table_header">
					...
					<h4>Eliminar Localidad</h4>
				</div>
				<div class="modal-body">
					<p class="texto-modal">¿ Está seguro de eliminar la localidad "<strong>{{$localidad->nombre}}</strong>" ?</p>
				</div>
