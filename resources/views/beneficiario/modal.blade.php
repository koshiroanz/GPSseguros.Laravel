<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-delete-{{$beneficiario->id}}">
	{{Form::open(array('action' => array('BeneficiarioController@destroy', $beneficiario->id), 'method' => 'delete'))}}
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p class="texto-modal">¿ Está seguro de eliminar el beneficiario "<strong>{{$beneficiario->nombre}} {{$beneficiario->apellido}}</strong>" ?</p>
				</div>
